...
export const COMPANIES: Company[] = [
  {
    ...
    listings: [{ market: "NASDAQ", ticker: "AAPL", currency: "USD", kind: "primaria" }, { market: "Borsa Italiana (GEM)", ticker: "AAPL.MI", currency: "EUR", kind: "secondaria", note: "negoziabile in euro da Milano" }],
  },
  {
    ...
    listings: [{ market: "NASDAQ", ticker: "MSFT", currency: "USD", kind: "primaria" }, { market: "Borsa Italiana (GEM)", ticker: "MSFT.MI", currency: "EUR", kind: "secondaria" }],
  },
  {
    ...
    peers: ["AVGO", "TSM", "ASML", "005930.KS"], themes: ["semiconductors", "ai"], domain: "nvidia.com", etoroSlug: "nvda",
    listings: [{ market: "NASDAQ", ticker: "NVDA", currency: "USD", kind: "primaria" }, { market: "Borsa Italiana (GEM)", ticker: "NVDA.MI", currency: "EUR", kind: "secondaria", note: "negoziabile in euro da Milano" }],
  },
  {
    ...
    listings: [{ market: "NASDAQ", ticker: "GOOGL", currency: "USD", kind: "primaria" }, { market: "Borsa Italiana (GEM)", ticker: "GOOGL.MI", currency: "EUR", kind: "secondaria" }],
  },
  {
    ...
    listings: [{ market: "NASDAQ", ticker: "AMZN", currency: "USD", kind: "primaria" }, { market: "Borsa Italiana (GEM)", ticker: "AMZN.MI", currency: "EUR", kind: "secondaria" }],
  },
  {
    ...
    listings: [{ market: "NYSE", ticker: "JNJ", currency: "USD", kind: "primaria" }, { market: "Borsa Italiana (GEM)", ticker: "JNJ.MI", currency: "EUR", kind: "secondaria" }],
  },
  {
    ...
    listings: [{ market: "NYSE", ticker: "KO", currency: "USD", kind: "primaria" }, { market: "Borsa Italiana (GEM)", ticker: "KO.MI", currency: "EUR", kind: "secondaria" }],
  },
  {
    ...
    listings: [{ market: "Euronext Amsterdam", ticker: "ASML", currency: "EUR", kind: "primaria" }, { market: "NASDAQ", ticker: "ASML", currency: "USD", kind: "secondaria", note: "quotazione USA" }],
  },
  {
    ...
    listings: [{ market: "XETRA (Francoforte)", ticker: "SAP", currency: "EUR", kind: "primaria" }, { market: "NYSE", ticker: "SAP", currency: "USD", kind: "ADR" }],
  },
  {
    ...
    listings: [{ market: "Borsa Italiana", ticker: "RACE.MI", currency: "EUR", kind: "primaria" }, { market: "NYSE", ticker: "RACE", currency: "USD", kind: "secondaria", note: "doppia quotazione Milano/New York" }],
  },
  {
    ...
    listings: [{ market: "Borsa Italiana", ticker: "ENEL.MI", currency: "EUR", kind: "primaria" }, { market: "OTC USA", ticker: "ENLAY", currency: "USD", kind: "ADR" }],
  },
  {
    ...
    listings: [{ market: "Borsa Italiana", ticker: "ISP.MI", currency: "EUR", kind: "primaria" }, { market: "OTC USA", ticker: "ISNPY", currency: "USD", kind: "ADR" }],
  },
  {
    symbol: "AVGO", name: "Broadcom Inc.", exchange: "NASDAQ", country: "US", currency: "USD",
    sector: "Tecnologia", industry: "Semiconduttori",
    description: "Semiconduttori per networking e AI custom (XPU) più software infrastrutturale (VMware).",
    peers: ["NVDA", "TSM", "005930.KS"], themes: ["semiconductors", "ai"], domain: "broadcom.com", etoroSlug: "avgo",
    listings: [{ market: "NASDAQ", ticker: "AVGO", currency: "USD", kind: "primaria" }, { market: "Borsa Italiana (GEM)", ticker: "AVGO.MI", currency: "EUR", kind: "secondaria" }],
  },
  {
    symbol: "TSM", name: "Taiwan Semiconductor (TSMC)", exchange: "NYSE (ADR)", country: "TW", currency: "USD",
    sector: "Tecnologia", industry: "Semiconduttori (fonderia)",
    description: "La più grande fonderia di chip al mondo: produce per NVIDIA, Apple, AMD e Broadcom. Sede e listino primario a Taiwan.",
    peers: ["NVDA", "AVGO", "ASML", "005930.KS"], themes: ["semiconductors", "ai"], domain: "tsmc.com", etoroSlug: "tsm",
    listings: [{ market: "TWSE (Taipei, Taiwan)", ticker: "2330.TW", currency: "TWD", kind: "primaria", note: "listino di casa: Taiwan, non Cina" }, { market: "NYSE", ticker: "TSM", currency: "USD", kind: "ADR", note: "1 ADR = 5 azioni ordinarie" }],
  },
  {
    symbol: "005930.KS", name: "Samsung Electronics", exchange: "KRX (Seul)", country: "KR", currency: "KRW",
    sector: "Tecnologia", industry: "Semiconduttori ed elettronica",
    description: "Colosso coreano: memorie (DRAM/NAND), smartphone, display e fonderia. Quotazione primaria alla borsa di Seul.",
    peers: ["TSM", "NVDA", "AVGO", "AAPL"], themes: ["semiconductors", "consumer-tech"], domain: "samsung.com",
    listings: [{ market: "KRX (Seul, Corea del Sud)", ticker: "005930.KS", currency: "KRW", kind: "primaria" }, { market: "London Stock Exchange", ticker: "SMSN", currency: "USD", kind: "GDR", note: "ricevute di deposito per investitori esteri" }],
  },
];
...
export const FUNDAMENTALS: Record<string, Fundamentals> = {
  ...
  AVGO: f("AVGO", "USD", {
    revenue: [27.5, 33.2, 35.8, 51.6, 62.0], netIncome: [6.7, 11.5, 14.1, 5.9, 17.0],
    ocf: [13.8, 16.7, 18.1, 20.0, 26.0], capex: [0.4, 0.4, 0.5, 0.5, 0.6],
    shares: [4.10, 4.15, 4.20, 4.65, 4.70],
    totalDebt: 68, cash: 11, ebitda: 30,
    grossMargin: 0.62, operatingMargin: 0.28, netMargin: 0.27, roe: 0.28, roic: 0.12,
    currentRatio: 1.0, interestCoverage: 5.5, eps: 3.6, divYield: 0.012, payout: 0.45,
    pe: 38, fwdPe: 30, ps: 17, pb: 18, evEbitda: 25, priceFcf: 35,
    peRange: { low: 15, high: 45, median: 28 }, beta: 1.5, mcap: 1600,
  }),
  TSM: f("TSM", "USD", {
    revenue: [56.8, 75.9, 69.3, 90.1, 108.0], netIncome: [21.4, 34.1, 26.9, 36.5, 45.0],
    ocf: [30.2, 44.9, 37.4, 49.2, 60.0], capex: [30.0, 36.3, 30.4, 29.8, 38.0],
    shares: [5.19, 5.19, 5.19, 5.19, 5.19],
    totalDebt: 30, cash: 60, ebitda: 68,
    grossMargin: 0.55, operatingMargin: 0.45, netMargin: 0.41, roe: 0.28, roic: 0.22,
    currentRatio: 2.4, interestCoverage: 50, eps: 8.1, divYield: 0.012, payout: 0.30,
    pe: 28, fwdPe: 24, ps: 11, pb: 7.5, evEbitda: 15, priceFcf: 40,
    peRange: { low: 10, high: 32, median: 18 }, beta: 1.2, mcap: 1150,
  }),
  "005930.KS": f("005930.KS", "KRW", {
    revenue: [279600, 302200, 258900, 300900, 325000], netIncome: [39900, 55600, 15500, 34500, 42000],
    ocf: [65100, 62200, 44100, 66000, 72000], capex: [48200, 53100, 53600, 56000, 58000],
    shares: [6.79, 6.78, 6.77, 6.76, 6.75],
    totalDebt: 18000, cash: 100000, ebitda: 80000,
    grossMargin: 0.37, operatingMargin: 0.12, netMargin: 0.13, roe: 0.11, roic: 0.09,
    currentRatio: 2.6, interestCoverage: 40, eps: 6200, divYield: 0.025, payout: 0.25,
    pe: 14, fwdPe: 11, ps: 1.4, pb: 1.3, evEbitda: 4.8, priceFcf: 18,
    peRange: { low: 8, high: 20, median: 13 }, beta: 1.0, mcap: 500000,
  }),
  "ISP.MI": f("ISP.MI", "EUR", {
