...
export const COMPANIES: Company[] = [
  {
    ...
    peers: ["MSFT", "GOOGL", "AMZN"], themes: ["consumer-tech", "ai"],
  },
  {
    ...
    peers: ["AAPL", "GOOGL", "AMZN"], themes: ["cloud", "ai"],
  },
  {
    ...
    peers: ["ASML", "MSFT"], themes: ["semiconductors", "ai"],
  },
  {
    ...
    peers: ["MSFT", "AMZN", "AAPL"], themes: ["ai", "cloud"],
  },
  {
    ...
    peers: ["MSFT", "GOOGL"], themes: ["cloud", "consumer-tech"],
  },
  {
    ...
    peers: ["KO"], themes: ["healthcare", "dividends"],
  },
  {
    ...
    peers: ["JNJ"], themes: ["consumer-staples", "dividends"],
  },
  {
    ...
    peers: ["NVDA", "SAP"], themes: ["semiconductors", "ai"],
  },
  {
  ...
  },
  {
    ...
    peers: ["ENEL.MI", "ISP.MI"], themes: ["luxury", "italy"],
  },
  {
    ...
    peers: ["ISP.MI", "RACE.MI"], themes: ["energy", "dividends", "italy"],
  },
  {
    ...
    peers: ["ENEL.MI", "RACE.MI"], themes: ["financials", "dividends", "italy"],
  },
];
